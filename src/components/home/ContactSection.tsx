              ...
              >
                <div className="relative p-8">
                  ...
                  <div className="relative grid md:grid-cols-2 gap-8 justify-end">
                    ...
                    >
                      <div>
                        <h2 className="text-2xl font-dynapuff font-semibold text-orange-500 mb-3 drop-shadow-[0_0_8px_rgba(251,146,60,0.3)]">Contact Information</h2>
                        <p className="text-white/90 font-dynapuff">Get in touch with our dedicated team for assistance and inquiries.</p>
                      </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="text-white/90">
                          ...
                          <p className="text-white font-dynapuff ml-7">contact@company.com</p>
                        </div>
                        ...
                        <div className="text-white/90">
                          ...
                          <p className="text-white font-dynapuff ml-7">+1 (555) 123-4567</p>
                        </div>
                        ...
                        <div className="text-white/90">
                          ...
                          <p className="text-white font-dynapuff ml-7">123 La cigogne<br />Kenitra</p>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div>
                        <h2 className="text-2xl font-dynapuff font-semibold text-orange-500 mb-3 drop-shadow-[0_0_8px_rgba(251,146,60,0.3)]">Connect With Us</h2>
                        <p className="text-white/90 font-dynapuff">Follow us on social media to stay updated with our latest news and events.</p>
                      </div>
